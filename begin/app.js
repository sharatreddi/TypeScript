...
class Department {
    constructor(id, name) {
        ...
        //private name : string;
        this.employees = []; //it is basically a medio thing between public and private, private means u had access only in the particular class, PROTECTED means it can be accesible by only those classes which extend this class
